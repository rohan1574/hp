                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<a href='edit_routine.php?id=" . $row['id'] . "' class='text-blue-500 hover:text-blue-700'>Edit</a> | ";
                                    echo "<a href='delete_routine.php?id=" . $row['id'] . "' class='text-red-500 hover:text-red-700' onclick='return confirm(\"Are you sure you want to delete this routine?\")'>Delete</a>";
                                    echo "</td>";
                                    echo "</tr>";
                                }
                            } else {
    ...
    <div id="routine-modal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
        <div class="bg-white p-8 rounded-lg shadow-lg w-1/2">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-xl font-bold">Add Class Routine</h3>
            ...
            <form method="POST" class="bg-white shadow-md rounded-lg p-6 mb-6">
                ...
                <div class="mt-6 flex justify-end">
                    <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded-md shadow hover:bg-blue-600">Save Routine</button>
                </div>
            </form>
        </div>
    </div>
